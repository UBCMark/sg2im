...
class Sg2ImModel(nn.Module):
  def __init__(self, vocab, image_size=(128, 128), embedding_dim=64,
  ...
  def forward(self, objs, triples, obj_to_img=None, attributes=None,
    ...
    obj_vecs_orig = torch.cat((obj_vecs, attributes), dim=1)
