...
VG_DIR = '/scratch/zhaobo/Datasets/vg'
VG_REGION_DIR = '/scratch/markma/Datasets/vg'
...
parser.add_argument('--regions_json',
                    default=os.path.join(VG_REGION_DIR, 'region_descriptions.json'))
...
parser.add_argument('--min_attribute_instances', default=200,
                    type=int)  # reduce the value to include more attributes. used to be 2000
...
parser.add_argument('--output_vocab_json',
                    default=os.path.join("/scratch/markma/sg2im/sg2im/data", 'vocab.json'))
parser.add_argument('--output_h5_dir', default="/scratch/markma/sg2im/sg2im/data")
...
def create_attribute_vocab(args, image_ids, attributes, vocab):
    ...
    for v, (name, count) in enumerate(attribute_name_counter.most_common()):
        # if count >= args.min_attribute_instances and len(attribute_names) < 128:
    ...
    print(attribute_name_counter.most_common(256))

    # attributes of interest for training
    # attribute_names = ['white', 'black', 'green', 'blue', 'brown', 'red', 'large', 'yellow', 'gray', 'wooden', 'grey', 'small',
    #              'tall', 'long', 'dark', 'standing', 'clear', 'metal', 'orange', 'tan', 'here', 'sitting', 'silver',
    #              'pink', 'wood', 'short', 'big', 'parked', 'brick', 'cloudy', 'young', 'round', 'walking', 'striped',
    #              'open', 'glass', 'purple', 'bare', 'smiling', 'plastic', 'blonde', 'empty', 'old', 'wet', 'looking',
    #              'bright', 'beige', 'concrete', 'stone', 'playing', 'hanging', 'dirty', 'calm', 'leafy', 'light',
    #              'little', 'eating', 'colorful', 'tiled', 'grassy', 'square', 'thick', 'dry', 'painted', 'gold', 'paved',
    #              'fluffy', 'closed', 'shiny', 'thin', 'part', 'one', 'light brown', 'plaid', 'dead', 'light blue',
    #              'covered', 'wearing', 'sandy', 'present', 'cement', 'leather', 'dirt', 'overcast', 'leafless', 'skiing',
    #              'distant', 'growing', 'flying', 'chain link', 'full', 'back', 'close', 'watching', 'blurry', 'beautiful',
    #              'grazing', "man's", 'curved', 'running', 'framed', 'on', 'dark brown', 'clean', 'rectangular', 'snowy',
    #              'holding', 'cloudless', 'furry', 'leaning', 'dark blue', 'wide', 'laying', 'in background', 'stuffed',
    #              'paper', 'baby', 'huge', 'jumping', 'moving', 'spotted', 'tile', 'curly', 'hazy', 'surfing',
    #              'skateboarding', 'circular', 'khaki']

    attribute_names = ['blonde', 'tile', 'white', 'wooden', 'light', 'skateboarding', 'walking', 'dark', 'red',
                       'wet', 'tiled', 'grassy', 'looking', 'stuffed', 'gold',
                       'furry', 'moving', 'old', 'wood', 'distant', 'framed', 'colorful',
                       'round', 'fluffy', 'tall', 'brown', 'orange', 'watching', 'silver', 'running', 'leafy',
                       'purple', 'covered', 'circular', 'dark brown', 'sandy', 'young', 'laying', 'skiing',
                       'clear', 'light blue', 'dark blue', 'standing', 'spotted',
                       'pink', 'open', 'paved', 'short', 'cloudy', 'plaid', 'chain link', 'striped', 'plastic',
                       'glass', 'hazy', 'playing', 'ceramic', 'wearing', 'gray', 'dirty', 'dirt', 'beige', 'large',
                       'small', "man's", 'eating', 'baby', 'tan', 'leafless', 'parked', 'yellow', 'curly', 'on',
                       'jumping', 'big', 'khaki', 'thick', 'metal', 'closed', 'snowy',
                       'sitting', 'smiling', 'dead', 'rectangular', 'long', 'cement', 'concrete', 'surfing',
                       'square', 'clean', 'green', 'bright', 'dry', 'flying', 'blue', 'black',
                       'light brown', 'grazing', 'cloudless', 'bare', 'brick', 'overcast', 'calm', 'thin',
                       'grey', 'little']

    # attribute_names = ['brown', 'gray', 'green', 'orange', 'white', 'grey', 'yellow', 'black', 'blue', 'red']
    # attribute_names = ['tall', 'tiled', 'red', 'painted', 'bare', 'here', 'big', 'green', 'parked', 'striped', 'standing', 'cloudy', 'round', 'dry', 'glass', 'black', 'square', 'blue', 'old', 'hanging', 'grassy', 'leafy', 'short', 'looking', 'concrete', 'white', 'playing', 'brown', 'metal', 'eating', 'wooden', 'plastic', 'grey', 'gray', 'pink', 'blonde', 'light', 'sitting', 'young', 'orange', 'small', 'colorful', 'empty', 'beige', 'dark', 'wet', 'thick', 'silver', 'smiling', 'walking', 'tan', 'dirty', 'clear', 'large', 'bright', 'calm', 'little', 'brick', 'stone', 'purple', 'long', 'open', 'wood', 'yellow']
...
def encode_graphs(args, splits, objects, relationships, vocab,
    ...
    for split, image_ids in splits.items():
        ...
        for image_id in image_ids:
            ...
            # Pad attribute info out to max_objects_per_image
            while len(object_attributes) < args.max_attributes_per_image:
                object_attributes.append(30 * [-1])
            ...
            image_object_attributes.append(object_attributes)
        ...
        numpy_arrays[split] = {
            ...
            'object_attributes': np.asarray(image_object_attributes),
        }
