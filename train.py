...
VG_DIR = os.path.expanduser('/home/mark1123/data/mark1123/vg')
COCO_DIR = os.path.expanduser('/home/mark1123/data/mark1123/coco')
...
def main(args):
  ...
  while True:
    ...
    for batch in train_loader:
      ...
      masks = None
      if len(batch) == 7: # vg
        imgs, objs, boxes, triples, obj_to_img, triple_to_img, attributes = batch
      ...
      with timeit('forward', args.timing):
        model_boxes = boxes
        model_masks = masks
        model_out = model(objs, triples, obj_to_img, attributes,
